...
import { CommentPhotoComponent } from 'app/entities/comment-photo/comment-photo.component';
...
describe('Component Tests', () => {
  describe('CommentPhoto Management Component', () => {
    let comp: CommentPhotoComponent;
    let fixture: ComponentFixture<CommentPhotoComponent>;
    let service: CommentPhotoService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [LazyblobTestModule],
        declarations: [CommentPhotoComponent],
        providers: [
          {
        ...
        .overrideTemplate(CommentPhotoComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(CommentPhotoComponent);
