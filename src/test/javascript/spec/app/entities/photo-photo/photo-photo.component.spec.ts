...
import { PhotoPhotoComponent } from 'app/entities/photo-photo/photo-photo.component';
...
describe('Component Tests', () => {
  describe('PhotoPhoto Management Component', () => {
    let comp: PhotoPhotoComponent;
    let fixture: ComponentFixture<PhotoPhotoComponent>;
    let service: PhotoPhotoService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [LazyblobTestModule],
        declarations: [PhotoPhotoComponent],
        providers: [
          {
        ...
        .overrideTemplate(PhotoPhotoComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(PhotoPhotoComponent);
