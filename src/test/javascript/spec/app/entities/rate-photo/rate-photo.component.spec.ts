...
import { RatePhotoComponent } from 'app/entities/rate-photo/rate-photo.component';
...
describe('Component Tests', () => {
  describe('RatePhoto Management Component', () => {
    let comp: RatePhotoComponent;
    let fixture: ComponentFixture<RatePhotoComponent>;
    let service: RatePhotoService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [LazyblobTestModule],
        declarations: [RatePhotoComponent],
        providers: [
          {
        ...
        .overrideTemplate(RatePhotoComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(RatePhotoComponent);
