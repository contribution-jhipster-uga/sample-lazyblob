...
import sample.lazyblob.config.audit.AuditEventConverter;
import sample.lazyblob.domain.PersistentAuditEvent;
...
import static sample.lazyblob.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
