...
public class PhotoCriteria implements Serializable, Criteria {
    ...
    public PhotoCriteria(PhotoCriteria other){
        ...
        this.belongToId = other.belongToId == null ? null : other.belongToId.copy();
    }
    ...
    public LongFilter getBelongToId() {
        return belongToId;
    }

    public void setBelongToId(LongFilter belongToId) {
    ...
    public boolean equals(Object o) {
        ...
        return
            ...
            Objects.equals(belongToId, that.belongToId);
    }
    ...
    public String toString() {
        return "PhotoCriteria{" +
                ...
                (belongToId != null ? "belongToId=" + belongToId + ", " : "") +
            "}";
    }
