...
public class PhotoDTO implements Serializable {
    ...
    public void setBelongToId(Long albumId) {
        this.belongToId = albumId;
    }

    public String getBelongToTitle() {
        return belongToTitle;
    }

    public void setBelongToTitle(String albumTitle) {
        this.belongToTitle = albumTitle;
    }
